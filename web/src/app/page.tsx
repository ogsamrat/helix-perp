...
const FEATURES = [
  ...
  { title: "Access control and pause", body: "OpenZeppelin role-based access control, a global kill-switch and per-market pause gate every privileged action." },
];
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <section className="relative">
        ...
        <div className="relative mx-auto grid max-w-6xl items-center gap-14 px-6 pb-16 pt-20 md:pt-28 lg:grid-cols-[1.05fr_0.95fr]">
          <div>
            <p className="eyebrow mb-7 animate-reveal-up" style={{ animationDelay: "0ms" }}>
              Decentralized perpetual futures · Soroban
            </p>
            <h1
              className="font-display max-w-2xl animate-reveal-up text-[3.25rem] leading-[0.95] tracking-tight text-ink sm:text-6xl md:text-7xl"
              style={{ animationDelay: "80ms" }}
            >
              Leverage the <span className="italic text-brand">real</span> world.
            </h1>
            <p
            ...
            >
              ...
              USDC. The one chain whose entire thesis is the real world.
            </p>
        ...
        {/* live marquee (decorative — real prices in the markets list) */}
        <div aria-hidden className="glass relative border-y border-hairline py-3.5">
      ...
      <Reveal>
        <section className="mx-auto max-w-6xl px-6">
          <div className="grid grid-cols-2 divide-x divide-hairline overflow-hidden rounded-2xl border border-hairline bg-surface/50 backdrop-blur-sm md:grid-cols-4">
            ...
            {MARKETS.map((m, i) => {
              ...
              return (
                ...
                >
                  ...
                  <div>
                    <div className="font-display text-2xl tracking-tight text-ink md:text-3xl">{m.ticker}</div>
